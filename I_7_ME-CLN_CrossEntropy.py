...
#                print(f'val_Multitask_classifier_output:{val_Multitask_classifier_output.shape}')
        ...
        print(f"ME-CLN_CrossEntropy,Epoch {epoch + 1}/{epochs}, Train Loss: {epoch_train_loss:.4f}, "
    ...
    torch.save(loss_data, 'D:/sunfengkui/ME-CLN_CrossEntropy/ME-CLN_CrossEntropy_loss_data.pth')
...
def test(AP_model,IQ_model,Assistant_DNN,Multitask_classifier,test_loader):
    ...
    with torch.no_grad():
        ...
        for snr, accuracy in accuracy_per_snr.items():
            ...
            torch.save(features, f"D:/sunfengkui/ME-CLN_CrossEntropy/TSNE/all_features of {snr}dB,lr={lr},epoch={epoch}128_5.pt")
        ...
        torch.save(snr_targets, f"D:/sunfengkui/ME-CLN_CrossEntropy/confusion_matrix/confusion_matrix_snr_targets.pt")
        torch.save(snr_predictions, f"D:/sunfengkui/ME-CLN_CrossEntropy/confusion_matrix/confusion_matrix_snr_predictions.pt")

    torch.save(AP_model.state_dict(),
               f"D:/sunfengkui/ME-CLN_CrossEntropy/model_state_dict/AP_model.pth")
    torch.save(IQ_model.state_dict(),
               f"D:/sunfengkui/ME-CLN_CrossEntropy/model_state_dict/IQ_model.pth")
    torch.save(Assistant_DNN.state_dict(),
               f"D:/sunfengkui/ME-CLN_CrossEntropy/model_state_dict/Assistant_DNN_model.pth")
    torch.save(Multitask_classifier.state_dict(),
               f"D:D:/sunfengkui/ME-CLN_CrossEntropy/model_state_dict/Multitask_classifier.pth")
